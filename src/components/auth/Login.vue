        ...
        if (valid) {
          ...
          try {
            ...
            if (result.success) {
              ...
              if (result.error && result.error.response && result.error.response.data && result.error.response.data.non_field_errors && result.error.response.data.non_field_errors.length > 0) {
                errorMsg = result.error.response.data.non_field_errors[0]
              }
